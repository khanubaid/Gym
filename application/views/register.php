                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active text-align form-new" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="row register-form">
                                <div class="col-md-12">
                                    <form role="form" method="post" action="<?php echo base_url('user/register_member'); ?>">
                          <fieldset>
                              ...
                              <div class="form-group">
                                  <select class="form-control" placeholder="Mobile No" name="class_name" type="text" value="">
                                  ...
                                  <!-- <input class="form-control" placeholder="Class Name" name="class_name" type="text" value=""> -->
                              </div>
