<h4>
Unlikely other workouts, It is a basic gym workout to perform and as a result, you can lose weight and increase your stamina. All you require is your own particular body weight and enough space to get down on every one of your fours at full stretch (No gym equipment or dumbbells required for beginners).
</h4>
   <?php
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Student Registration</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Student Login</a>
                        </li>
                    </ul>  
