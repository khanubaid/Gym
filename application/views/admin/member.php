    ...
    function edit_book(id)
    {
      ...
      $.ajax({
        ...
        success: function(data)
        {
            ...
            $('[name="user_age"]').val(data.user_age);
        ...
        <form action="#" id="form" class="form-horizontal">
          ...
          <div class="form-body">
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="user_email" placeholder="User Email" class="form-control" type="text">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="user_password" placeholder="User Password" class="form-control" type="Password">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="class_name" placeholder="User Class" class="form-control" type="text">
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-md-3">Member Hight</label>
              <div class="col-md-9">
                <input name="height" placeholder="Member Hight" class="form-control" type="text">
              </div>
            </div>

            <div class="form-group">
              <label class="control-label col-md-3">Member weight</label>
              <div class="col-md-9">
                <input name="weight" placeholder="Member weight" class="form-control" type="text">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="user_mobile" placeholder="Phone No" class="form-control" type="text">
              </div>
            </div>

            <div class="form-group">
              <label class="control-label col-md-3">Member Age</label>
              <div class="col-md-9">
                <input name="user_age" placeholder="Member Age" class="form-control" type="text">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="date" placeholder="User Email" class="form-control" type="date">
              </div>
            </div>
            
            <div class="form-group">
              <label class="control-label col-md-3">Date Of Brith</label>
              <div class="col-md-9">
                <input name="DOB" placeholder="User Class" class="form-control" type="date">
              </div>
            </div>
            ...
            <div class="form-group" style="display: none;">
              ...
              <div class="col-md-9">
                <input name="trainer_member" placeholder="Member" class="form-control" type="text" value="Member">
              </div>
            </div>
