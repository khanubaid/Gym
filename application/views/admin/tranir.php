        ...
        <div class="col-sm-12">
          <div class="panel panel-default text-left">
            <div class="panel-body">
              <p contenteditable="true"><b><h4>Tranir Search</h4></b>
...
<div>      
       <br/>
    <button class="btn btn-success" onclick="add_book()"><i class="glyphicon glyphicon-plus"></i> Add Tranir</button>
    <br/>
    <br/>
        ...
        <form action="#" id="form" class="form-horizontal">
          ...
          <div class="form-body">
            ...
            <div class="form-group" style="display: none;">
              <label class="control-label col-md-3">Treanir</label>
              <div class="col-md-9">
                <input name="trainer_member" placeholder="Treanir" class="form-control" type="text" value="Trainer">
